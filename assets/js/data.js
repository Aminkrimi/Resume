/*
 * همهٔ محتوای سایت اینجاست — برای ویرایش رزومه فقط همین فایل را تغییر بده.
 * All site content lives here — edit this file to update the resume.
 * Every text field is { fa, en }.
 */
window.CV = {
  person: {
  ...
  projects: [
    ...
    },
    {
      ...
      img: 'assets/img/ordibehesht.webp',
